...
public class Employee implements Serializable {
	 ...
	 * out.writeInt(id); out.writeInt(personId); out.writeUTF(company);
	 * 
	 * }
	 * 
	 * @Override public void readData(ObjectDataInput in) throws IOException { id =
	 * in.readInt(); personId = in.readInt(); company = in.readUTF(); }
	 */
